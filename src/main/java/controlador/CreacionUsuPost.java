...
/**
 * Servlet implementation class CreacionUsuPost
 */
@WebServlet("/CreacionUsuPost")
public class CreacionUsuPost extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreacionUsuPost() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Administrativo adm = new Administrativo(area, correo, runAdm );
